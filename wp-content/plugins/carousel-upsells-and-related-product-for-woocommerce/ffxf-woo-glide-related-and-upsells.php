...
function ffxf_registering_style_glide(){
	wp_register_style('ffxf_glide-core', plugin_dir_url( __FILE__ ) . 'assets/css/glide.core.min.css', array(), '0.4.3');
    wp_register_style('ffxf_glide-theme', plugin_dir_url( __FILE__ ) . 'assets/css/glide.theme.min.css', array(), '0.4.3');
...
function ffxf_registering_script_glide(){
    wp_register_script('ffxf_glide', plugin_dir_url( __FILE__ ) . 'assets/js/glide.min.js', array(), '0.4.3', true);
}
...
function ffxf_registering_script_glide_admin(){
    ...
    if ( isset( $_GET['section'] ) && $_GET['section'] === 'glideffxf_related' || isset( $_GET['section'] ) && $_GET['section'] === 'glideffxf_upsells' ) {
	    ...
	    wp_enqueue_style('ffxf-glide-core', plugin_dir_url( __FILE__ ) . 'assets/css/glide.core.min.css', array(), '0.4.3');
	    wp_enqueue_style('ffxf-glide-theme', plugin_dir_url( __FILE__ ) . 'assets/css/glide.theme.min.css', array(), '0.4.3');

	    wp_enqueue_script('ffxf-glide', plugin_dir_url( __FILE__ ) . 'assets/js/glide.min.js', array(), '0.4.3', true);

	    wp_enqueue_style( 'ffxf-settings-related', plugins_url( '/assets/css/ffxf_settings_related.css', __FILE__ ), array(), '0.4.3' );

	    wp_enqueue_script( 'ffxf-plugin-upsells-admin', plugin_dir_url( __FILE__ ) . 'assets/js/ffxf_plugin_upsells_admin.js', array(), '0.4.3', true);
	    wp_localize_script(
...
function ffxf_registering_script_relat() {
	...
	wp_enqueue_style( 'ffxf_related_and_upsale_sing_admin', plugins_url( '/assets/css/related_and_upsale_sing_admin.css', __FILE__ ), array(), '0.4.3' );
	wp_enqueue_style( 'ffxf_tooltip', plugins_url( '/assets/css/ffxf_tooltip.css', __FILE__ ), array(), '0.4.3' );

	wp_enqueue_script( 'ffxf_settings_relat', plugins_url( '/assets/js/related_and_upsale_sing_admin.js', __FILE__ ), array('jquery'), '0.4.3', true );
	wp_localize_script(
		'ffxf_settings_relat',
		'ffxf_settings_locale',
		array(
...
function ffxf_registering_notice_related_and_upsells_script() {
	wp_register_script( 'glideffxf-rate-related-and-upsells', plugins_url( '/assets/js/ffxf_rate_related_and_upsells.js', __FILE__ ), array('jquery'), '0.4.3', true );
	wp_localize_script(
